...
public class PieceValidatorTest {
	...
	public void testValidatorWithEmptyList(){
		...
		assertFalse(validator.isValidMove(null, null, new HantoPieceImpl(HantoPlayerColor.BLUE,BUTTERFLY), null, null, null));
	}
	...
	public void testValidatorWithItemsInListAndValidMove(){
		...
		assertTrue(validator.isValidMove(null, null, new HantoPieceImpl(HantoPlayerColor.BLUE,BUTTERFLY), null, null, null));
	...
	public void testValidatorWithItemsInListAndINValidMove(){
		...
		validList.add(SPARROW);
		validator = new PieceValidator(validList);
		assertFalse(validator.isValidMove(null, null, new HantoPieceImpl(HantoPlayerColor.BLUE,CRAB), null, null, null));
