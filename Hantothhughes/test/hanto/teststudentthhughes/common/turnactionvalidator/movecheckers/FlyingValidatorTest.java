...
public class FlyingValidatorTest {
	class MoveData {
	...
	@Test
	public void sparrowFlysOneHex() throws HantoException
	{
		assertTrue(tav.isValidMove(theBoard, new HantoPieceImpl(BLUE,SPARROW), new MoveCounterImpl(), 
	...
	@Test
	public void sparrowFlysThreeHex() throws HantoException
	{
		assertTrue(tav.isValidMove(theBoard, new HantoPieceImpl(BLUE,SPARROW), new MoveCounterImpl(), 
	...
	@Test
	public void sparrowFlysOverObstacletwoHex() throws HantoException
	{
		assertTrue(tav.isValidMove(theBoard, new HantoPieceImpl(BLUE,SPARROW), new MoveCounterImpl(), 
	...
	@Test
	public void sparrowFlysOverObstacleThreeHex() throws HantoException
	{
		assertTrue(tav.isValidMove(theBoard, new HantoPieceImpl(BLUE,SPARROW), new MoveCounterImpl(), 
				makeCoordinate(1,1), makeCoordinate(-1,0)));
	}
	...
	@Test
	public void sparrowFlysTooFarOverObstacleThreeHex() throws HantoException
	{
		tav = new FlyingValidator(2);
		assertFalse(tav.isValidMove(theBoard, new HantoPieceImpl(BLUE,SPARROW), new MoveCounterImpl(), 
				makeCoordinate(1,1), makeCoordinate(-1,0)));
	}
	
	@Test
	public void sparrowFlysToLocationThatIsOccupied() throws HantoException
	{
		fillBoard(md(SPARROW,1,0));
		assertFalse(tav.isValidMove(theBoard, new HantoPieceImpl(BLUE,SPARROW), new MoveCounterImpl(), 
				makeCoordinate(1,0), makeCoordinate(-1,0)));
	}
