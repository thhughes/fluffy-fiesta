...
public class MovePieceOnBoardValidatorTester {
	...
	public void testNotNull(){
		assertNotNull(new MovePieceOnBoardValidator());
	}
	
	@Test(expected=HantoException.class)
	public void testInvalidError() throws HantoException
	{
		(new MovePieceOnBoardValidator()).invalidError();
	}
	
	@Test
	public void testPlacingAPiece() throws HantoException
	{
		boolean result = (new MovePieceOnBoardValidator()).isValidMove(theBoard,
