 ...
 *
 */
public class GammaHantoGameBackup implements HantoGame {
	 ...
	 * 					BoardValidator :
	 */
	public GammaHantoGameBackup(HantoPlayerColor firstMovePlayer, TurnActionValidator mValidator, GameStateEvaluator bValidator){
